...
<!-- END array hari dan bulan -->
    ...
    <div class="content-header">
      <div class="col-md-12">
                        <h2 style="color: hsl(0, 60%, 50%)"><b>Riwayat Peserta Batal Magang/PKL</b></h2> 
                    </div>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Menu</a></li>
        <li class="active">Riwayat Peserta Batal Magang/PKL</li>
      </ol>
    </section>
...
<div id="myTabContent" class="tab-content">
 <!-- tab riwayat batal magang -->
     ...
     <form method="post" action="?page=batal&aksi=batalmagangfilter">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" ID="dataTables-batalmagang">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $koneksi->query("SELECT * FROM `tb_batalmagang` WHERE TanggalMasuk  BETWEEN '".$tanggalawal."' AND '".$tanggalakhir."' ORDER BY TanggalMasuk");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a href="?page=batal&aksi=profilbatalmagang&ID=<?php echo $data['ID']; ?>" class="btn btn-info btn-md"><i. class="fa fa-eye"></i.></a></center>
                                            </td>
                                        </tr>
