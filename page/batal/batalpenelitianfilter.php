...
<!-- END array hari dan bulan -->
    ...
    <div class="content-header">
      <div class="col-md-12">
                        <h2 style="color: hsl(0, 60%, 50%)"><b>Riwayat Batal Peserta Penelitian</b></h2>                        
                    </div>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Menu</a></li>
        <li class="active">Riwayat Batal Peserta Penelitian</li>
      </ol>
    </section>
...
<div id="myTabContent" class="tab-content">
 <!-- tab riwayat batal penelitian -->
     ...
     <form method="post" action="?page=batal&aksi=batalpenelitianfilter">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" ID="dataTables-batalpenelitian">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $koneksi->query("SELECT * FROM `tb_batalpenelitian` WHERE TanggalMasuk1 BETWEEN '".$tanggalawal."' AND '".$tanggalakhir."' ORDER BY TanggalMasuk1");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a href="?page=batal&aksi=profilbatalpenelitian&ID1=<?php echo $data['ID1']; ?>" class="btn btn-info btn-md"><i. class="fa fa-eye"></i.></a></center>
                                            </td>
                                        </tr>
