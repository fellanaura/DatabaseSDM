...
<!-- END array hari dan bulan -->
    ...
    <div class="content-header">
      <div class="col-md-12">
                        <h2 style="color: hsl(0, 60%, 50%)"><b>Riwayat Peserta Kunjungan</b></h2> 
                    </div>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Menu</a></li>
        <li class="active">Riwayat Peserta Kunjungan</li>
      </ol>
    </section>
...
<div id="myTabContent" class="tab-content">
 <!-- tab riwayat magang -->
     ...
     <form method="post" action="?page=riwayatkunjunganfilter">
...
<a href="./page/riwayat peserta/printexcelkunjungan.php" class="btn btn-default pull-right" style="background: #8b0000; color: #fff; margin-bottom: 10px" target="blank"><i. class="fa fa-print"></i.> ExploreToExcel</a>       
<br>      
<br>
      <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" ID="dataTables-riwayatkunjungan">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $koneksi->query("SELECT * FROM `tb_kunjungan` WHERE TanggalKunjungan BETWEEN '".$tanggalawal."' AND '".$tanggalakhir."' ORDER BY TanggalKunjungan");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a href="?page=riwayat peserta&aksi=profilkunjungan&ID=<?php echo $data['ID']; ?>" class="btn btn-info btn-md"><i. class="fa fa-eye"></i.></a></center>
                                            </td>
                                        </tr>
